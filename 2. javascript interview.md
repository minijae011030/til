...
<details>
<summary>TDZ가 존재하는 이유는 무엇인가요?</summary>
...
<details>
<summary>전역 스코프를 남용하면 어떤 문제가 생기나요?</summary>
...
<details>
<summary>클로저는 어떤 원리로 동작하나요?</summary>
...
<details>
<summary>async 함수는 왜 항상 Promise를 반환하나요?</summary>

async 함수 내부의 반환값은 자동으로 Promise로 감싸지기 때문입니다.
...
이벤트 루프는 Call Stack이 비었을 때 Task Queue와 Microtask Queue를 확인해 작업을 실행하는 역할을 합니다.
...
<details>
<summary>이벤트 위임이 가능한 이유는 무엇인가요?</summary>

이벤트가 버블링을 통해 상위 요소로 전달되기 때문에 가능합니다.
