...
모듈화를 위해 중복되는 Alert·Storage 코드를 모듈로 추출해 한 곳에서 관리하도록 구조화했습니다.
...
iOS와 Android를 동시에 개발해야 했고 빠르게 MVP를 만들어야 해서 RN을 선택했습니다.

또한 React 기반이라 웹 개발 경험을 그대로 확장할 수 있었고,
HTML과 비슷한 컴포넌트 구조로 화면을 구성할 수 있어 초기 진입 장벽이 낮다는 점도 큰 이유였습니다.

</details>

<details>
<summary>무거운 UI에서 렌더링 지연 문제를 어떻게 해결하나요?</summary>

불필요한 상태 업데이트를 막고 memoization을 적용하며, FlatList 최적화도 함께 적용할 수 있습니다.
FlatList에서는 keyExtractor, getItemLayout, initialNumToRender, windowSize 등을 조합하면 성능을 향상할 수 있습니다.
