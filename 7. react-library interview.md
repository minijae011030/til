...
- MVVM
  ...
  - ViewModel이 Model의 역할을 수행하고, View와 ViewModel 사이에서 데이터를 중개합니다.
  - ViewModel과 View 간의 양방향 데이터 바인딩 때문에 테스트하기가 어려울 수 있습니다. 
  - MVVM은 Angular, Vue.js 등의 프레임워크에서 사용됩니다.
- Flux
  - 반면 Flux는 단방향 데이터 흐름을 사용하여 Action -> Dispatcher -> Store -> View의 방향으로 데이터가 흐릅니다. 
  - Store가 애플리케이션의 데이터와 비즈니스 로직을 담당하고, Dispatcher를 통해 Action을 처리합니다. 
